// Standalone test of the ablation study framework
// Tests the structure and logic without API dependencies
...
// Generate agent configurations (same logic as main file)
...
// Evaluation functions (same logic as main file)
